...
from gs2colmap.gaussian_renderer.renderer_cuda import CUDARenderer

# from gs2colmap import DISCOVERSE_ASSERT_DIR
# from gs2colmap.viewer.gs_render import MOBILE_AI_ASSERT_DIR

class GSRenderer:
    def __init__(self, models_dict:dict, render_width=640, render_height=480):
        ...
        data_path = Path(models_dict[bg_key])
    ...
    def render(self, render_depth=True, render_normal=True, use_surface_depth=True):
        self.update_camera_intrin_lazy()
        return self.renderer.draw(render_depth, render_normal, use_surface_depth=use_surface_depth)
